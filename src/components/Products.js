...
const Products = () => {
  ...
  // CRIO_TASK_MODULE_PRODUCTS - Fetch products data and store it
  /**
  ...
  // CRIO_TASK_MODULE_PRODUCTS - Implement search logic
  /**
  ...
  // CRIO_TASK_MODULE_PRODUCTS - Optimise API calls with debounce search implementation
  /**
  ...
  // CRIO_TASK_MODULE_CART - Return if a product already exists in the cart
  /**
  ...
  return (
    <div>
      <Header hasHiddenAuthButtons={false}>
        {/* CRIO_TASK_MODULE_PRODUCTS - Display search bar in the header for Products page */}
        <TextField
